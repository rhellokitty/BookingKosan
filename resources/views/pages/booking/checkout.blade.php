...
@section('content')
    ...
    <div id="TopNav" class="relative flex items-center justify-between px-5 mt-[60px]">
        <a href="{{ route('booking.information', $boardingHouses->slug) }}"
    ...
    <form action="{{ route('booking.payment', $boardingHouses->slug) }}" class="relative flex flex-col gap-6 mt-5 pt-5"
        method="POST">
        @csrf
        <div id="PaymentOptions" class="flex flex-col rounded-[30px] border border-[#F1F2F6] p-5 gap-4 mx-5">
            ...
            <div id="TabContent-Container">
                @php
                    $subtotal = $rooms->price_per_month * $transaction['duration'];
                    $tax = $subtotal * 0.11;
