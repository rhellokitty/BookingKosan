...
@section('content')
        ...
        <div class="flex flex-col w-full rounded-[30px] border border-[#F1F2F6] p-4 gap-4 bg-white">
            ...
            <div class="flex gap-4">
                ...
                <div class="flex flex-col gap-3 w-full">
                    ...
                    <div class="flex items-center gap-[6px]">
                        <img src="assets/images/icons/profile-2user.svg" class="w-5 h-5 flex shrink-0" alt="icon">
                        <p class="text-sm text-ngekos-grey">{{ $transaction->room->capacity }} Capacity</p>
                    </div>
                    <div class="flex items-center gap-[6px]">
                        <img src="assets/images/icons/3dcube.svg" class="w-5 h-5 flex shrink-0" alt="icon">
                        <p class="text-sm text-ngekos-grey">{{ $transaction->room->square_feet }} Square Feet</p>
                    </div>
                    <div class="flex items-center gap-[6px]">
    ...
    <div
        ...
        @php
            ...
            $grandtotal = $transaction->payment_method === 'full_payment' ? $total : $total * 0.3;
        @endphp
        ...
        <div class="flex flex-col gap-4 pt-[22px]">
            ...
            <div class="flex items-center justify-between">
                ...
                {{-- LANJUTKAN DI MENIT 8:15 --}}
            </div>
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <img src="assets/images/icons/receipt-disscount.svg" class="w-6 h-6 flepppppx shrink-0"
                        alt="icon">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3"> <img src="assets/images/icons/receipt-text.svg"
